...
Всего 51 тест. Запуск: `make test`

Проверяемые функции: `ParseArgs`, `ParseFlags`, `OpenInput`, `CloseInput`, `OptionsFree` — объявлены в [src/args.h](../src/args.h).
...
| `test_flags_help_silent` | `--help` | 0 | не ошибка, stderr пуст, поле взведено |
